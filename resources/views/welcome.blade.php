        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
              <a class="navbar-brand text-center" href="#">
                <img src="{{ asset('images/logo.png') }}" alt="logo" width="100" class="">
                {{-- Cadoan.vn             --}}
            </a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a href="{{ url('/admin') }}" class="nav-link">Quản trị</a>
                </li>
                  <li class="nav-item">
                ...
                @if (Route::has('login'))
                    @auth
                        ...
                        <a href="{{ url('/admin') }}" class="nav-link mr-4">Cá nhân</a>
                    ...
                    <tr data-entry-id="{{ $event->id }}">
                        ...
                        <td>
                            ...
                            @else
                                ...
                                <table class="table table-bordered {{ ($key%2 == 0) ? 'table-primary' : 'table-success' }}">
                                    <th>#</th>
                                    <th>Loại</th>
                                    <th>Tên bài hát</th>
                                    <th>Sách</th>
