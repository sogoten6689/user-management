        ...
        <form action="{{ route('admin.musics.update', $music->id) }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="song_name">Tên bài*</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('public') is-invalid @enderror" id="public" name="public">
                        <option value="1" {{ old('public', $music->public) == '1' ? 'selected' : '' }}>Có</option>
                        <option value="0" {{ old('public', $music->public) == '0' ? 'selected' : '' }}>Không</option>
                    </select>
                    @error('public')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
